function [ss_estim] = iekf(y, t, is_artifact, m, num_iters,  num_particles, verbose)
...
% initial reference trajectory. It selects the predictive draw of maximum 
% likelihood as the intial reference trajectory.
%
